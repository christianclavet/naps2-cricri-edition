...
This is an unofficial release. This a release for this fork, and could be compared to Naps2 v6.2
Features that this fork and version haves that have been added:
...
NOTES:
The application build is in 64bit and support all the memory you have. There could be an issue with scanning with really big images from TWAIN, as this as been resolved with the new BETA.
...
- [Get current release HERE](https://github.com/christianclavet/naps2-cricri-edition/releases/download/v6.2_CriCriEdition/naps2-CriCri-edition.6.2.0-setup.exe)
